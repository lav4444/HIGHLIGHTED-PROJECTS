...
public class MainTeacher {
	public static void main(String[] args) {
		...
		Teacher t1 = new Teacher("Dario", "Tušek", 42, "dario.tusek@fer.hr", "OOP", 10000);
		Teacher t2 = new Teacher("Doris", "Bezmalinović", 43, "doris.bezmalinovic@fer.hr", "OOP", 10000);

		Student s1 = new Student("Janko", "Horvat", 18, "0036312123", (short)1); 
		Student s2 = new Student("Ana", "Kovač", 19, "0036387656", (short)2); 
		Student s3 = new Student("Ivana", "Stanić", 19, "0036392357", (short)1);
